...
public class frmConsulta1 extends javax.swing.JFrame {
    ...
    public frmConsulta1(frmConsulta fC) {
        initComponents();
    ...
    public void mostrarDatos(){
        ...
        tblConsulta1.setModel(model);
        try {
            ResultSet resultado = objConexion.consultarRegistros("SELECT ID_Lider, Nombre, Primer_Apellido, Ciudad_Residencia FROM Lider\n" +
                                         "ORDER BY Ciudad_Residencia");
            while (resultado.next()){
               
                Object[] usuario = {resultado.getString("ID_Lider"),
